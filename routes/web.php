...
use App\Http\Controllers\Front\FrontAssistantController;
use App\Http\Controllers\PatientQrCodeAssistantController;
use App\Http\Controllers\TransactionAssistantController;
use App\Http\Controllers\NotificationAssistantController;
...
Route::post('create-google-calendar-patient',[AppointmentAssistantController::class, 'createGoogleEventForPatient'])->name('createGoogleEventForPatient');



// ADMINISTRATEUR

Route::post('create-google-calendar-doctor',[AppointmentController::class, 'createGoogleEventForDoctor']
)->name('createGoogleEventForDoctor');

Route::post('create-google-calendar-doctor',[AppointmentAssistantController::class, 'createGoogleEventForAssistant']
)->name('createGoogleEventForDoctor');
...
// Route::middleware('setLanguage')->group(function () {
//     Route::get('/', [FrontAssistantController::class, 'medical'])->name('medical-assistant');

//     Route::get('/medical-assistant-about-us', [FrontAssistantController::class, 'medicalAboutUs'])->name('medicalAboutUs');
//     Route::get('/medical-assistant-services', [FrontAssistantController::class, 'medicalServices'])->name('medicalServices');
//     Route::get('/medical-assistant-appointment', [FrontAssistantController::class, 'medicalAppointment'])->name('medicalAppointment');
//     Route::get('/medical-assistants', [FrontAssistantController::class, 'medicalAssistants'])->name('medicalAssistants');
//     Route::get('/medical-assistant-contact', [FrontAssistantController::class, 'medicalContact'])->name('medicalContact');
//     Route::get('/terms-assistant-conditions', [FrontAssistantController::class, 'termsCondition'])->name('terms.conditions');
//     Route::get('/privacy-assistant-policy', [FrontAssistantController::class, 'privacyPolicy'])->name('privacy.policy');
//     Route::get('/faqs', [FrontAssistantController::class, 'faq'])->name('front.faqs');
//     Route::get('qr-code/p/{id?}', [PatientQrCodeAssistantController::class, 'show'])->name('patient_show');
// });
...
//Change language
Route::post('/change-language', [FrontAssistantController::class, 'changeLanguage'])->name('front.change.language');

//Dark Mode
Route::get('update-dark-mode', [UserController::class, 'updateDarkMode'])->name('update-dark-mode');
//Dark Mode
Route::get('update-dark-mode', [AssistantController::class, 'updateDarkMode'])->name('update-dark-mode');
...
//Stripe route Assistant
Route::get(
    '/medical-assistant-payment-success',
    [AppointmentAssistantController::class, 'paymentSuccess']
)->name('medical-appointment-assistant-payment-success');
...
Route::get(
    '/medical-assistant-payment-failed',
    [AppointmentAssistantController::class, 'handleFailedPayment']
)->name('medical-appointment-assistant-failed-payment');
...
// Manually payment route
Route::get('/manually-assistant-payment', [AppointmentAssistantController::class, 'manuallyPayment'])->name('manually-assistant-payment');
Route::put('transaction-assistant-status', [TransactionAssistantController::class, 'changeTransactionStatus'])->name('transaction-assistant.status');
...
Route::get('assistant-session-time', [AssistantsSessionController::class, 'getAssistantSession'])->name('assistant-session-time');
...
Route::post('front-appointment-book',[AppointmentController::class, 'frontAppointmentBook']
)->name('front.appointment.book');
Route::post('medical-appointment',[AppointmentController::class, 'frontHomeAppointmentBook']
...
// Assistant
Route::post('front-appointment-assistant-book',[AppointmentAssistantController::class, 'frontAppointmentBook']
)->name('front.appointment.book.assistant');
Route::post('medical-appointment-assistant',[AppointmentAssistantController::class, 'frontHomeAppointmentBook']
)->name('front.home.appointment.book.assistant');
Route::get('get-patient-name', [AppointmentAssistantController::class, 'getPatientName'])->name('get-patient-name');


//change Language
Route::post('update-language', [UserController::class, 'updateLanguage'])->name('change-language');
//change Language
Route::post('update-language', [AssistantController::class, 'updateLanguage'])->name('change-language');
...
Route::get('assistatnt-appointment/{doctor}', [AppointmentAssistantController::class, 'doctorBookAppointment'])->name('assistantBookAppointment');
Route::get('service-appointment-assistatnt/{service}', [AppointmentAssistantController::class, 'serviceBookAppointment'])->name('serviceAssistantBookAppointment');

Route::post('/notification/{notification}/read', [NotificationController::class, 'readNotification']
)->name('notifications.read');
Route::post('/read-all-notification',[NotificationController::class, 'readAllNotification']
)->name('notifications.read.all');

Route::post('/notification/{notification}/read', [NotificationAssistantController::class, 'readNotification']
)->name('notifications.read');
Route::post('/read-all-notification',[NotificationAssistantController::class, 'readAllNotification']
)->name('notifications.read.all');
...
Route::get('cancel-appointment-assistant/{patient_id}/{appointment_unique_id}', [AppointmentAssistantController::class, 'cancelAppointment'])->name('cancelAppointment-assistant');
...
Route::prefix('admin')->middleware('auth', 'xss', 'checkUserStatus', 'checkImpersonateUser')->group(function () {
    ...
    //Impersonate
    //    Route::impersonate();
    Route::get('impersonate/{id}', [AssistantController::class, 'impersonate'])->name('impersonate');
    Route::get('impersonate-leave', [AssistantController::class, 'impersonateLeave'])->name('impersonate.leave');

    //Email verified
    Route::post('email-verified', [UserController::class, 'emailVerified'])->name('emailVerified');
    //Email verified
    Route::post('email-verified', [AssistantController::class, 'emailVerified'])->name('emailVerified');
    ...
    Route::middleware('permission:manage_doctors')->group(function () {
        ...
        Route::get('doctors-appointment',[UserController::class, 'doctorAppointment']
    ...
    // Assistant route
    Route::middleware('permission:manage_assistant')->group(function () {
        Route::resource('assistants', AssistantController::class);
         // horaires des assistants
        Route::get('assistant/session', [AssistantController::class, 'sessionData'])->name('assistants.session');
        Route::get('asstts-apptmt',[AssistantController::class, 'assistantAppointment']
        )->name('assistants.appointment-assistant');
        Route::post('/add-qualification-assistant', [AssistantController::class, 'addQualification'])->name('add.qualification-assistant');
        Route::put('assistant-status', [AssistantController::class, 'changeAssistantStatus'])->name('assistant.status');
    });
    ...
    Route::middleware('permission:manage_settings')->group(function () {
        ...
        Route::resource('asstt-holidy', AssistantHolidayController::class);
    ...
    Route::middleware('permission:manage_patients')->group(function () {
        ...
        Route::get('patient-appointments-assistant', [PatientController::class, 'patientAppointment'])->name('patients.appointments-assistant');
    });
    ...
    // Assistant Schedule Routes
    Route::middleware('permission:manage_assistant_sessions')->group(function () {
    ...
    //     Route::post('appointments/{appointment}',[AppointmentController::class, 'changeStatus']
    //     )->name('change-status');
    //     Route::post('appointments-payment/{id}',[AppointmentController::class, 'changePaymentStatus']
    //     )->name('change-payment-status');
    //     Route::get('appointment-pdf/{id}', [AppointmentController::class, 'appointmentPdf'])
    //     ->name('admin.appointmentPdf');
    //     Route::get('transactions', [TransactionController::class, 'index'])->name('transactions');
    //     Route::get('transactions/{transaction}', [TransactionController::class, 'show'])->name('transactions.show');
    // });
    // Route::get('admin-appointments-calendar', [AppointmentController::class, 'appointmentCalendar']
    // )->name('appointments.calendar');


    Route::middleware('permission:manage_appointments')->group(function () {
        // Routes pour les rendez-vous des administrateurs
        Route::resource('appointments', AppointmentController::class)->except(['edit', 'update']);

        Route::post('appointments/{appointment}', [AppointmentController::class, 'changeStatus'])->name('appointments.change-status');
        Route::post('appointments-payment/{id}', [AppointmentController::class, 'changePaymentStatus'])->name('appointments.change-payment-status');
        Route::get('appointment-pdf/{id}', [AppointmentController::class, 'appointmentPdf'])->name('appointmentPdf');
        Route::get('transactions', [TransactionController::class, 'index'])->name('transactions.index');
        Route::get('transactions/{transaction}', [TransactionController::class, 'show'])->name('transactions.show');
    });

    // Route pour le calendrier des rendez-vous administratifs
    Route::get('admin-appointments-calendar', [AppointmentController::class, 'appointmentCalendar'])->name('appointments.calendar');



    // Appointment pour le travailleur social
    Route::middleware('permission:manage_assistant_appointments')->group(function () {
        // Route::resource('asstts-apptmt', AppointmentAssistantController::class)->except(['edit', 'update']);
        Route::resource('asstts-apptmt', AppointmentAssistantController::class)->except(['edit', 'update']);
        Route::get('asstts-apptmt/create', [AppointmentAssistantController::class, 'create'])->name('asstts-apptmt.create');

        Route::post('asstts-apptmt/{appointment-assistant}',
            [AppointmentAssistantController::class, 'changeStatus']
        )->name('change-status-assistant');
        Route::post('appointments-assistant-payment/{id}',
            [AppointmentAssistantController::class, 'changePaymentStatus']
        )->name('change-payment-status-assistant');
        Route::get('appointment-pdf-assistant/{id}', [AppointmentAssistantController::class, 'appointmentPdf-assistant'])->name('assistant-appointmentPdf');
        Route::get('transactions', [TransactionController::class, 'index'])->name('transactions');
        Route::get('transactions/{transaction}', [TransactionController::class, 'show'])->name('transactions.show');
    });
    Route::get('admin-assistant-appointments-assistant-calendar', [AppointmentAssistantController::class, 'appointmentCalendar']
    )->name('asstts-apptmt.calendar');
    ...
    Route::middleware('permission:manage_patient_assistance')->group(function () {
        Route::resource('assistances', PortezAssistanceController::class);
        // Route::post('add-problem', [PortezAssistanceController::class, 'addProblem'])->name('add.problem');
        // Route::post('delete-problem/{problem}', [PortezAssistanceController::class, 'deleteProblem']
        // )->name('delete.problem');
        // Route::post('add-observation', [PortezAssistanceController::class, 'addObservation'])->name('add.observation');
        // Route::post('delete-observation/{observation}', [PortezAssistanceController::class, 'deleteObservation']
        // )->name('delete.observation');
        // Route::post('add-note', [PortezAssistanceController::class, 'addNote'])->name('add.note');
        // Route::post('delete-note/{note}', [PortezAssistanceController::class, 'deleteNote'])->name('delete.note');
        // Route::post('add-prescription', [PortezAssistanceController::class, 'addPrescription'])->name('add.prescription');
        // Route::post('delete-prescription/{prescription}', [PortezAssistanceController::class, 'deletePrescription']
        // )->name('delete.prescription');
        // Route::get('edit-prescription/{prescription}', [PortezAssistanceController::class, 'editPrescription']
        // )->name('edit.prescription');
    });
    ...
    // Resend Email Verification Mail
    Route::post('/email/verification-notification/{userId}', [AssistantController::class, 'resendEmailVerification'])->name('resend.email.verification');
...
Route::post('create-meeting', [LiveConsultationController::class, 'createMeeting'])->name('create.meeting');
// Route::post('create-meeting', [LiveZoomController::class, 'createMeeting'])->name('create.meeting');
...
Route::get('/env-test', function() {
    ...
    dd("Client ID: {$clientId}, Client Secret: {$clientSecret}, Account ID: {$accountId}");
});
