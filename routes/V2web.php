...
Route::middleware('setLanguage')->group(function () {
    ...
    Route::get('/medical-appointment-assistant', [FrontController::class, 'medicalAppointmentAssistant'])->name('medicalAppointmentAssistant');
...
Route::get(
    '/medical-payment-success-assistant',
...
Route::get('assistant-session-time', [AssistantSessionController::class, 'getAssistantSession'])->name('assistant-session-time');
...
Route::prefix('admin')->middleware('auth', 'xss', 'checkUserStatus', 'checkImpersonateUser')->group(function () {
    ...
    Route::middleware('permission:manage_assistant')->group(function () {
        ...
        Route::get('assistants-appointment',[AssistantController::class, 'assistantAppointment']
    ...
    Route::middleware('permission:manage_assistant_sessions')->group(function () {
        Route::resource('assistant-sessions', AssistantSessionController::class);
        Route::get('/get-slot-by-gap', [AssistantSessionController::class, 'getSlotByGap'])->name('get.slot.by.gap');
    }); 
    ...
    Route::middleware('permission:manage_assistant_appointments')->group(function () {
        Route::resource('appointments-assistant', AppointmentAssistantController::class)->except(['edit', 'update']);
        Route::post(
            'appointments-assistant/{appointment-assistant}',
            [AppointmentAssistantController::class, 'changeStatus']
        )->name('change-status');
        Route::post(
            'appointments-assistant-payment/{id}',
            [AppointmentAssistantController::class, 'changePaymentStatus']
        )->name('change-payment-status');
        Route::get(
            'appointment-pdf/{id}',
            [AppointmentAssistantController::class, 'appointmentPdf-assistant']
        )->name('admin.appointmentPdfèassistant');
        Route::get('transactions', [TransactionController::class, 'index'])->name('transactions');
        Route::get('transactions/{transaction}', [TransactionController::class, 'show'])->name('transactions.show');
    });
    Route::get('admin-appointments-assistant-calendar', [AppointmentAssistantController::class, 'appointmentCalendar-assistant']
