...
class DashboardController extends AppBaseController
{
    ...
    // dashboard du travaileur social 
    public function assistantDashboard(Request $request): \Illuminate\View\View
    {
        $appointments = $this->dashboardRepository->getAssistantData();
        $doctorAllAppointment = $this->dashboardRepository->AssistantAllAppointment();
        return view('assistant_dashboard.index', compact('appointments','doctorAllAppointment')
    );
    }
     /**
     * @return Application|Factory|View 
    ...
    // LES FONCTIONS CONCERNANT LES PARAMETRES DE L'ASSISTANT 

    // public function assistantDashboard(): \Illuminate\View\View
    // {
       
    //     return view('assistants_dashboard.index');
    // }
