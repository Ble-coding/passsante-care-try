...
/**
 * Class GoogleMeetRepository
 */
class GoogleMeetRepository
{
    public function connectWithGoogleMeet($code)
    {
        $userGoogleMeetCredential = \App\Models\UserGoogleMeetCredential::where('user_id', getLogInUserId())->first();

        $clientID = $userGoogleMeetCredential->google_meet_api_key;
        $secret = $userGoogleMeetCredential->google_meet_api_secret;

        $client = new Client(['base_uri' => 'https://meet.google.com']);
