 ...
 */
class DataVisiteurRepository extends BaseRepository
{
    /**
     ...
     public function store($input): bool
{
    try {
        ...
        $dataVisiteur = new DataVisiteur();
        $dataVisiteur->assistant_id = $input['assistant_id'];
        $dataVisiteur->visiteur_id = $input['visiteur_id'];
        $dataVisiteur->heure_debut = $input['heure_debut'];
        $dataVisiteur->heure_fin = $input['heure_fin'];
        $dataVisiteur->statut = $input['statut'];
        $dataVisiteur->vulnerabilites = $input['vulnerabilites'];
        $dataVisiteur->type = $input['type'];
        $dataVisiteur->motif_enquete = $input['motif_enquete'];
        $dataVisiteur->decision = $input['decision'];
        $dataVisiteur->etat_enquete = $input['etat_enquete'];
        $dataVisiteur->motif_service = $input['motif_service'];
        $dataVisiteur->autre_motif_service = $input['autre_motif_service'];
        $dataVisiteur->activites_menees = $input['activites_menees'];
        $dataVisiteur->autres_activites = $input['autres_activites'];
        $dataVisiteur->delai = $input['delai'];
        $dataVisiteur->resultat_realisation = $input['resultat_realisation'];
        $dataVisiteur->devenir_du_cas = $input['devenir_du_cas'];
        $dataVisiteur->observation = $input['observation'];
    ...
    {
        $data['visiteurs'] = Visiteur::select(DB::raw("CONCAT(nom, ' ', prenom) AS nom_complet"), 'id')->pluck('nom_complet', 'id');
