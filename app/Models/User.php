...
class User extends Authenticatable implements HasMedia
{
    ...
    // const ASSISTANT = 5; // Ajout du role assistant
    ...
    const ASSISTANT = 2; // Ajout du role assistant
    ...
    const TYPE = [
        ...
        self::STAFF => 'Staff',
        self::ASSISTANT => 'Assistant', //Ajout du type de role
    ];
    ...
    // Ajout de la relation assistant
    // public function assistant(): HasOne
    // {
    //     return $this->hasOne(Assistant::class);
    // }
     /**
     * Récupère les groupes auxquels ce visiteur appartient.
     */
    ...
    public function googleMeetCredential(): HasOne
    {
        return $this->hasOne(UserGoogleMeetCredential::class, 'user_id');
    }
}
