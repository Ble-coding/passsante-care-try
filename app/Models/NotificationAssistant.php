 ...
 * @mixin \Eloquent
 */
class NotificationAssistant extends Model
{
    use HasFactory;
    ...
    const APPOINTMENT_CREATE_ASSISTANT_MSG = 'pris rendez-vous avec vous au';
    ...
    const APPOINTMENT_CANCEL_ASSISTANT_MSG = 'rendez-vous annulé avec vous à';
