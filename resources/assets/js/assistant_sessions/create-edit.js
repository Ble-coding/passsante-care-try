document.addEventListener('turbo:load', loadAssistantSessionData)

function loadAssistantSessionData () {
    let assistantSessionIsEdit = $('#assistantSessionIsEdit').val();
    if (!assistantSessionIsEdit == true) {
...
listenSubmit('#saveFormAssistant', function (e) {
    e.preventDefault()
