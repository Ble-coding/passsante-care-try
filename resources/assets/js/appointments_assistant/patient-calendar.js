document.addEventListener('turbo:load', loadPatientAppointmentAssistantCalendar)
...
function loadPatientAppointmentAssistantCalendar () {
    if (!$('#appointmentAssistantCalendar').length) {
        return
    }
    initCalendarApp()
    init()
...
const initCalendarApp = function () {
    ...
    let calendarEl = document.getElementById('appointmentAssistantCalendar');
    calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function (info, successCallback, failureCallback) {
            $.ajax({
                url: route('patients.assistants-appointment.calendar'),
                type: 'GET',
                data: info,
        ...
        eventMouseEnter: function (arg) {
            formatArgs({
                ...
                assistantName: arg.event.extendedProps.assistantName,
            })
...
const formatArgs = (res) => {
    ...
    data.assistantName = res.assistantName
}
...
const initPopovers = (element) => {
    ...
    const popoverHtml = '<div class="fw-bolder mb-2"><b>Assistant</b>: ' +
        data.assistantName +
...
const handleViewEvent = () => {
    ...
    // Populate view data
    viewEventName.innerText = 'Assistant: ' + data.assistantName
