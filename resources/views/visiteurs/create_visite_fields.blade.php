                ...
                <span class="is-valid">
                    <div class="mt-2">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="1" id="motif_1"
                                {{ !empty($visite) && $visite->motif_enquete === 1 ? 'checked' : '' }} required>
                            <label class="form-check-label mb-2" for="motif_1">{{ __('messages.motif_1') }}</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="2" id="motif_2"
                                {{ !empty($visite) && $visite->motif_enquete === 2 ? 'checked' : '' }} required>
                            <label class="form-check-label mb-2" for="motif_2">{{ __('messages.motif_2') }}</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="3" id="motif_3"
                                {{ !empty($visite) && $visite->motif_enquete === 3 ? 'checked' : '' }} required>
                            <label class="form-check-label mb-2" for="motif_3">{{ __('messages.motif_3') }}</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="4" id="motif_4"
                                {{ !empty($visite) && $visite->motif_enquete === 4 ? 'checked' : '' }} required>
                            <label class="form-check-label mb-2" for="motif_4">{{ __('messages.motif_4') }}</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="5" id="motif_5"
                                {{ !empty($visite) && $visite->motif_enquete === 5 ? 'checked' : '' }} required>
                            <label class="form-check-label mb-2" for="motif_5">{{ __('messages.motif_5') }}</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="6" id="motif_6"
                                {{ !empty($visite) && $visite->motif_enquete === 6 ? 'checked' : '' }} required>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="motif_enquete" value="7"
                                id="motif_7" {{ !empty($visite) && $visite->motif_enquete === 7 ? 'checked' : '' }}
                                required>
                ...
                <div class="mt-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="etat_enquete" value="1"
                            id="etat_enquete1"
                            {{ !empty($visite) && $visite->etat_enquete === 1 ? 'checked' : '' }} required>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="etat_enquete" value="2"
                            id="etat_enquete2"
                            {{ !empty($visite) && $visite->etat_enquete === 2 ? 'checked' : '' }} required>
                        <label class="form-check-label"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="etat_enquete" value="3"
                            id="etat_enquete3"
                            {{ !empty($visite) && $visite->etat_enquete === 3 ? 'checked' : '' }} required>
                        <label class="form-check-label"
