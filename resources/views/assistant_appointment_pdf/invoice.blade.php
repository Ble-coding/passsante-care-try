                        ...
                        <table class="table w-100 ">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="font-color">{{ $datas->assistant->user->full_name }}</td>
                                </tr>
                                <tr>
                                    <th>Assistant Email:</th>
                                    <td class="font-color">{{ $datas->assistant->user->email }}</td>
                                </tr>
                                <tr>
                                    <th>Services:</th>
                        ...
                        <table class="table w-100 " style="padding-left:50px;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-color">{{ \App\Models\AppointmentAssistant::PAYMENT_METHOD[$datas->payment_method] }}</td>
                                </tr>
                                <tr>
                                    <th>Payment Status:</th>
                                    <td class="font-color">{{ \App\Models\AppointmentAssistant::PAYMENT_TYPE[$datas->payment_type] }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
            ...
            <tr>
                <td class="w-50 text-end">
                    <table class="table" style="margin-left:auto;margin-top:20px;width:50%;">
                        <tr>
                            <th>Assistant Appointment Date:</th>
                        </tr>
                        <tr>
                ...
                <td class="w-50">
                    <table class="table" style="margin-left:50px;margin-top:20px;width:50%;">
                        <tr>
                            <th>Assistant Appointment Time:</th>
                        </tr>
                        <tr>
