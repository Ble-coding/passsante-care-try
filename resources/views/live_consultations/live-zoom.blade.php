                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 mb-5">
                                ...
                                {{ Form::text('title', '', ['class' => 'form-control title-title','required','placeholder' => __('messages.live_consultation.consultation_title')]) }}
                            </div>
                            <div class="form-group col-sm-6 mb-5">
                                {{ Form::label('consultationDate', __('messages.live_consultation.consultation_date').(':'), ['class' => 'form-label required']) }}
                                {{ Form::text('start_date_time', '', ['class' => 'form-control start_date_time-date','required', 'autocomplete' => 'off','id'=>'consultationDate','placeholder' => __('messages.live_consultation.select_consultation_date')]) }}
                            </div>
                            {{-- <div class="form-group col-sm-6 mb-5">
                                <label for="consultation_date" class="form-label required fs-6 fw-bolder text-gray-700 mb-3">{{ __('messages.live_consultation.consultation_date') }}</label>
                                <input type="date" id="consultation_date" class="form-control consultation-date form-control-solid" wire:model="consultation_date" required autocomplete="off" placeholder="{{ __('messages.live_consultation.select_consultation_date') }}">
                            </div> --}}
                            <div class="form-group col-sm-6 mb-5">
                                ...
                                {{ Form::text('duration_in_minute', '', ['class' => 'form-control duration_in_minute','required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','min' => '0', 'max' => '720','placeholder' =>  __('messages.live_consultation.consultation_minutes')]) }}
                            </div>
                            <div class="form-group col-sm-6 mb-5">
