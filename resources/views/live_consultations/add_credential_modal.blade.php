    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('zoom_api_account', __('messages.live_consultation.zoom_api_account').(':'), ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('zoom_api_account', '', ['class' => 'form-control','required', 'id' => 'zoomApiAccount', 'autocomplete' => 'off']) }}
                    </div>
                </div>
                <div class="row">
                    <a href="https://www.linkedin.com/pulse/zoom-api-integration-laravel-godstime-john-lw3zf/" class="text-start text-decoration-none pt-1 pb-1" target="_blank">How to generate OAuth Credentials ?</a>
                </div>
