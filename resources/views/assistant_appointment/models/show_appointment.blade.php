<div class="modal fade event-modal" id="assistantAppointmentCalendarModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex align-items-center mt-4">
                    ...
                    <select class="form-select-sm form-select-solid form-select assistant-apptnt-calendar-status-change"
