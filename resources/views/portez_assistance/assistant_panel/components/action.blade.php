<div class="d-flex justify-content-center">
    <a href="{{ route('assistants.assistances.show', $row->id) }}" title="{{ __('messages.common.show') }}"
       class="btn px-1 text-primary fs-3" data-bs-toggle="tooltip" data-bs-original-title="{{ __('messages.common.show') }}">
        <i class="fas fa-eye fs-4"></i>
    </a>
    
    <a href="{{ route('assistants.assistances.edit', $row->id) }}" title="{{ __('messages.common.edit') }}"
    ...
    <a href="javascript:void(0)" data-id="{{ $row->id }}" title="{{ __('messages.common.delete') }}"  data-bs-toggle="tooltip"
       ...
       class="btn px-1 text-danger fs-3 assistant-assistance-delete-btn">
