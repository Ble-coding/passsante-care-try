<div class="d-flex align-items-center">
    <a href="{{route('assistants.show', $row->id)}}">
    ...
    <div class="d-flex flex-column">
        <div class="d-inline-block align-top">
            <div class="d-inline-block align-self-center d-flex">
                <a href="{{route('assistants.show', $row->id)}}" class="mb-1 text-decoration-none fs-6">
                    {{$row->user->full_name}}
                </a>
                <div class="star-ratings d-flex align-self-center ms-2">
                    @if($row->reviews_assistants->avg('rating') != 0)
                        @php
                            $rating = $row->reviews_assistants->avg('rating');
                        @endphp
