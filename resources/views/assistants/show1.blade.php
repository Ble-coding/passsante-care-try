    ...
    <div class="container-fluid">
        ...
        <div class="mt-7">
            <ul class="nav nav-tabs mb-sm-7 mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
                ...
                @role('assistant|manage_profils_sociaux_usagers')
                      <li class="nav-item position-relative me-7 mb-3" role="presentation">
                        <button class="nav-link p-0" id="overview-tab" data-bs-toggle="tab" data-bs-target="#overview"
                            type="button" role="tab" aria-controls="overview" aria-selected="true">
                            {{ __('messages.common.overview') }}
                        </button>
                    </li>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="appointments" role="tabpanel" aria-labelledby="appointments-tab">
                    ...
                    <livewire:visiteur-historque-table :visiteurId="$visiteur->id" />
