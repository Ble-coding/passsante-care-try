<div class="modal fade" id="serviceCreateServiceCategoryAssistantModal" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {{ Form::open(['id' => 'serviceCreateServiceCategoryAssistantForm']) }}
            <div class="modal-body">
                <div class="alert alert-danger d-none" id="createServiceCategoryAssistantValidationErrorsBox"></div>
                <div>
