...
<div class="col-lg-6">
    ...
    <div class="col-lg-6 mb-5">
        {{ Form::label('assistants', __('messages.assistants').':', ['class' => 'form-label required']) }}
        {{ Form::select('assistants[]',$data['assistants'],(isset($selectedAssistant)) ? $selectedAssistant : null,['class' => 'form-control io-select2', 'data-placeholder' => __('messages.assistant.select_doctors'), 'data-control'=>'select2','multiple']) }}
    </div>
    <div class="col-lg-12">
        <div class="mb-5">
    ...
    <div class="mb-5 col-lg-6">
        {{ Form::label('status', __('messages.assistant.status').':', ['class' => 'form-label']) }}
        @if(!empty($service))
            <div class="col-lg-8">
    ...
    <div>
        ...
        <a href="{{route('services-assistant.index')}}" type="reset"
