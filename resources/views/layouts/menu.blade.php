...
@role('patient')
    ...
    {{-- menu 2 --}}
    {{-- <li
        class="nav-item {{ Request::is('patients/assistants-appointment*', 'patients/patient-assistant-appointment-assistant-calendar*', 'patients/assistants*, ') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('patients.patient-assistant-appointments-assistant-index') }}" data-turbo="false">
            <span class="aside-menu-icon pe-3"><i class="fas fa-calendar-alt"></i></span>
            <span class="aside-menu-title">{{ __('messages.appointments_assistant') }}</span>
        </a>
    </li> --}}
    ...
    <li class="nav-item {{ Request::is('patients/patient-visits*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            ...
            <span class="aside-menu-title">{{ __('messages.historiques') }}</span>
        </a>
    </li>
    {{-- <li class="nav-item {{ Request::is('patients/patient-assistances*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('patients.patient.assistances.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-hand-holding-heart"></i></span>
            <span class="aside-menu-title">{{ __('messages.assistances') }}</span>
        </a>
    </li> --}}
    ...
    <li class="nav-item {{ Request::is('patients/my-card*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('patients.show_my_card') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-id-card"></i></span>
            <span class="aside-menu-title">{{ __('messages.smart_patient_card.patient_cards') }}</span>
        </a>
    </li>
@endrole
...
@if (isRole('patient'))
    <li
        class="nav-item {{ Request::is('patients/smart-patient-cards*', 'patients/generate-patient-smart-cards*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('patients.generate-patient-smart-cards.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-id-card"></i></span>
...
@role('doctor')
    ...
    {{-- <li class="nav-item {{ Request::is('doctors/live-consultations*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            ...
            <span class="aside-menu-icon pe-3"><i class="fas fa-video"></i></span>
            <span class="aside-menu-title">{{ __('messages.live_credentials') }}</span>
        </a>
    </li> --}}
    <li class="nav-item {{ Request::is('doctors/live-consultations*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
...
@role('assistant')
    <li class="nav-item {{ Request::is('assistants/dashboard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('assistants.dashboard') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa fa-digital-tachograph"></i></span>
            <span class="aside-menu-title">{{ __('messages.dashboard') }}</span>
        </a>
    </li>

    @can('manage_patient_assistance')
        <li class="nav-item {{ Request::is('assistants/assistances*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
                href="{{ route('assistants.assistances.index') }}">
                <span class="aside-menu-icon pe-3"><i class="fas fa-hand-holding-heart"></i></span>
                <span class="aside-menu-title">{{ __('messages.portez_assistance.main') }}</span>
            </a>
        </li>
    @endcan

    <li
        class="nav-item {{ Request::is('assistants/assistant-schedule-edit*', 'assistants/assistant-sessions/create') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ getLoginAssistantSessionUrl() }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-calendar"></i></span>
            <span class="aside-menu-title">{{ __('messages.assistant_session.my_schedule') }}</span>
        </a>
    </li>

    @can('manage_assistant_appointments')
        <li class="nav-item {{ Request::is('assistants/asstts-apptmt*', 'assistants/patient*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
                href="{{ route('assistants.asstts-apptmt') }}">
                <span class="aside-menu-icon pe-3"><i class="fas fa-calendar-alt"></i></span>
                <span class="aside-menu-title">{{ __('messages.appointment.appointments') }}</span>
                <span class="d-none">{{ __('messages.appointments_assistant') }}</span>
                <span class="d-none">{{ __('messages.patients') }}</span>
            </a>
        </li>
    @endcan
    ...
    {{-- @can('manage_patient_visits')
        <li class="nav-item {{ Request::is('assistants/doctor-visits*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.doctor-visits.index') }}">
                <span class="aside-menu-icon pe-3"><i class="fas fa-procedures"></i></span>
                <span class="aside-menu-title">{{ __('messages.visits') }}</span>
            </a>
        </li>
    ...
    <li class="nav-item {{ Request::is('assistants/holidays*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('assistants.holiday-assistant') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-calendar-xmark"></i></span>
            <span class="aside-menu-title">{{ __('messages.holiday.holiday') }}</span>
        </a>
    </li>
...
{{-- @if (isRole('assistant'))
    <li
        class="nav-item {{ Request::is('assistants/assistance-visiteurs*', 'assistants/historiques-visites*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('assistants.assistance-visiteurs.create') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-hand-holding-heart"></i></span>
            <span class="aside-menu-title">{{ __('messages.visitor.make_assistance') }}</span>
        </a>
    </li>
@endif --}}
...
{{-- DOCTEUR ET PATIENT  --}}
@if (!isRole('doctor') && !isRole('assistant') && !isRole('patient'))
    @can('manage_appointments')
        <li
...
@if (!isRole('doctor') && !isRole('assistant') && !isRole('patient'))
    @can('manage_assistant_appointments')
        {{-- <li
            class="nav-item {{ Request::is('admin/asstts-apptmt*',
    ...
    @can('manage_appointments')
        <li
            class="nav-item {{ Request::is(
                ' admin/appointments*',
                'admin/admin-appointments-calendar*',
                'admin/prescriptions*',
                'admin/prescription-medicine-show*',
            )
                ? 'active'
                : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
...
{{-- @if (!isRole('doctor') && !isRole('assistant') && !isRole('patient'))
    @can('manage_assistant_appointments')
        <li
            class="nav-item {{ Request::is(
                ' admin/asstts-apptmt*',
                'admin/admin-appointments-assistant-calendar*',
                'admin/prescriptions-assistant*',
                'admin/prescription-medicine-show*',
            )
                ? 'active'
                : '' }}">
...
@if (!isRole('doctor') && !isRole('patient') && !isRole('assistant'))
    @can('manage_patient_visits')
...
@if (!isRole('assistant') && !isRole('patient'))
    @can('manage_patient_assistance')
        {{-- <li class="nav-item {{ Request::is('admin/assistances*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
...
@can('manage_assistant')
    <li
        class="nav-item {{ Request::is('admin/assistants*', 'assistants/assistant-sessions*', 'admin/assistant-sessions*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-user-doctor"></i></span>
            <span class="aside-menu-title">{{ __('messages.assistants') }}</span>
            <span class="d-none">{{ __('messages.assistants') }}</span>
            <span class="d-none">{{ __('messages.assistant_sessions') }}</span>
        </a>
    </li>
@endcan
