...
@role('assistant')
    ...
    @can('manage_assistant_appointments')
        <li class="nav-item {{ Request::is('assistants/appointments*', 'assistants/patient*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
                href="{{ route('assistants.appointments') }}">
                <span class="aside-menu-icon pe-3"><i class="fas fa-calendar-alt"></i></span>
                <span class="aside-menu-title">{{ __('messages.appointment.appointments') }}</span>
                <span class="d-none">{{ __('messages.appointments') }}</span>
                <span class="d-none">{{ __('messages.patients') }}</span>
    ...
    <li class="nav-item {{ Request::is('assistants/holidays*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.holiday') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-calendar-xmark"></i></span>
            <span class="aside-menu-title">{{ __('messages.holiday.holiday') }}</span>
        </a>
    </li>
...
{{-- @can('manage_assistant')
    <li
        ...
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-user-assistant"></i></span>
