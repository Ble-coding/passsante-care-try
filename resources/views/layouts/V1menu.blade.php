...
{{-- DEFINITION DES MENU DE L'ASSISTANT ( Travailleur social) --}}
@role('assistant')
    <li class="nav-item {{ Request::is('assistants/dashboard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.dashboard') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa fa-digital-tachograph"></i></span>
            <span class="aside-menu-title">{{ __('messages.dashboard') }}</span>
        </a>
    </li>
    ...
    @can('manage_profils_sociaux_usagers')
        <li class="nav-item {{ Request::is('assistants/visiteurs*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
                href="{{ route('assistants.visiteurs.index') }}">
                <span class="aside-menu-icon pe-3"><i class="fas fa-users"></i></span>
                <span class="aside-menu-title">{{ __('messages.visitor.visitor') }}</span>
            </a>
        </li>
    @endcan
    @if (isRole('assistant'))
    ...
    {{-- @can('manage_interventions | manage_historique')
    <li class="nav-item {{ Request::is('assistants/assistance-visiteurs*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.assistance-visiteurs.create') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-hand-holding-heart"></i>
            </span>
            <span class="aside-menu-title">{{ __('messages.visitor.make_assistance') }}</span>
        </a>
    </li>
    ...
    {{-- @if (isRole('doctor'))
    <li class="nav-item {{ Request::is('doctors/smart-patient-cards*', 'doctors/generate-patient-smart-cards*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('doctors.smart-patient-cards.index') }}">
    ...
    {{-- @can('manage_historique')
    <li class="nav-item {{ Request::is('assistants/historiques-visites*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistants.historiques-visites.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-history"></i>
            </span>
            <span class="aside-menu-title">{{ __('messages.visitor.historique') }}</span>
        </a>
    </li>
    @endcan --}}
@endrole
...
@role('patient')
    ...
    <li class="nav-item {{ Request::is('patients/my-card*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('patients.show_my_card') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-id-card"></i></span>
...
{{-- AJOUT DE ROLE SUR L'INTERFACE ADMIN  --}}

@can('manage_assistant')
    <li class="nav-item {{ Request::is('admin/assistant*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('assistant.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-user-doctor"></i></span>
...
{{-- Travailleur social pour carte visiteur  --}}
@if (isRole('assistant'))
    <li
        class="nav-item {{ Request::is('doctors/smart-patient-cards*', 'doctors/generate-patient-smart-cards*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="#">
            {{-- <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('doctors.smart-patient-cards.index') }}"> --}}
            <span class="aside-menu-icon pe-3"><i class="fa-solid fa-id-card"></i></span>
            <span class="aside-menu-title">{{ __('messages.smart_visitor_card.smart_visitor_cards') }}</span>
        </a>
    </li>
@endif
