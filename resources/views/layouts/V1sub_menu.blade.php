...
@role('patient')
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('patients/appointments*', 'patients/patient-appointments-calendar*', 'patients/prescription-medicine-show*') ? 'd-none' : '' }}">
        {{-- pour le li --}}
        <a class="nav-link p-0 {{ Request::is('patients/appointments*', 'patients/patient-appointments-calendar*', 'patients/prescription-medicine-show*') ? 'active' : '' }}"
            href="{{ route('patients.patient-appointments-index') }}">{{ __('messages.doctor_appointments') }}</a>
    </li>
    {{-- 
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('patients/appointments*', 'patients/patient-appointments-calendar*', 'patients/prescription-medicine-show*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('patients/appointments-assit*', 'patients/patient-appointments-calendar*', 'patients/prescription-medicine-show*') ? 'active' : '' }}"
            href="{{ route('patients.appointments-assistant.index') }}">{{ __('messages.appointments_assistant') }}</a>
    </li> --}}

    {{-- <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('patients/appointments-assistant*', 'patients/patient-appointments-calendar*', 'patients/prescription-medicine-show*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('patients/appointments-assistant*') ? 'active' : '' }}"
            href="{{ route('patients.appointments-assistant.index') }}">{{ __('messages.appointments_assistant') }}</a>
    </li> --}}
...
@role('assistant')
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('assistants/visiteurs*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('assistants/visiteurs*') ? 'active' : '' }}"
            href="{{ route('assistants.visiteurs.index') }}">{{ __('messages.visitor.visitor_infos') }}</a>
    </li>

    {{-- <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('assistants/assistance-visiteurs*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('assistants/assistance-visiteurs*') ? 'active' : '' }}"
            href="{{ route('assistants.assistance-visiteurs.create') }}">{{ __('messages.visitor.make_assistance') }}</a>
    ...
    {{-- <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('assistants/assistance-visiteurs*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('assistants/assistance-visiteurs*') ? 'active' : '' }}"
            href="{{ route('assistants.historiques-visites.index') }}">{{ __('messages.visitor.histoy_title') }}</a>
    </li> --}}
@endrole
...
@can('manage_assistant')
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0
    {{ !Request::is('admin/assistant*', 'admin/assistant-sessions*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('admin/assistant*') ? 'active' : '' }}"
            href="{{ route('assistant.index') }}">{{ __('messages.assistants') }}</a>
    </li>
@endcan
...
@if (isRole('assistant'))
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 
        {{ !Request::is('assistants/assistance-visiteurs*', 'assistants/historiques-visites*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('assistants/assistance-visiteurs*') ? 'active' : '' }}"
            href="{{ route('assistants.assistance-visiteurs.create') }}"> {{ __('messages.visitor.make_assistance') }} </a>
    </li>
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 
        {{ !Request::is('assistants/assistance-visiteurs*', 'assistants/historiques-visites*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('assistants/historiques-visites*') ? 'active' : '' }}"
            href="{{ route('assistants.historiques-visites.index') }}">{{ __('messages.visitor.histoy_title') }}</a>
    </li>
...
@can('manage_appointments')
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/appointments*', 'admin/admin-appointments-calendar*', 'admin/prescriptions*', 'admin/prescription-medicine-show*') ? 'd-none' : '' }}">
