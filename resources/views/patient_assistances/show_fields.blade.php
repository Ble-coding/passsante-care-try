        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                    <label class="pb-2 fs-4 text-gray-600">{{ __('messages.portez_assistance.assistant') }}</label>
                    <span class="fs-4 text-gray-800">
                        {{ $assistance->assistanceAssistant->user->full_name }}
                    </span>
                </div>
                <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                    <label class="pb-2 fs-4 text-gray-600">{{ __('messages.user.email') }}</label>
                    <span class="fs-4 text-gray-800">{{ $assistance->assistanceAssistant->user->email }}</span>
                </div>
                <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                    <label class="pb-2 fs-4 text-gray-600">{{ __('messages.patient.profile') }}</label>
                    <img src="{{ $assistance->assistanceAssistant->user->profile_image }}"
                        class="object-cover image image-circle" alt="user" style="height: 50px; width: 50px">
                </div>
                <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                    <label class="pb-2 fs-4 text-gray-600">{{ __('messages.web.contact') }}</label>
                    {{-- <span
                        class="fs-4 text-gray-800">{{ \Carbon\Carbon::parse($assistance->assistanceAssistant->user->dob)->isoFormat('DD MMM YYYY') }}</span> --}}

                    <span class="fs-4 text-gray-800">{{ $assistance->assistanceAssistant->user->contact }}</span>
                ...
                <div class="col-md-12 d-flex flex-column mb-md-10 mb-5">
                    <label
                        class="pb-2 fs-4 text-gray-600">{{ __('messages.portez_assistance.assistance_date') }}</label>
                    <div class="fs-4 text-gray-800" style="max-height: 200px; overflow:auto;">
                        {{-- {!! nl2br(!empty($assistance->description) ? $assistance->description : 'N/A') !!} --}}
                        <span
                            class="fs-4 text-gray-800">{{ \Carbon\Carbon::parse($assistance->assistance_date)->isoFormat('DD MMM YYYY') }}</span>
                    </div>
                </div>
