    ...
    <div class="d-flex justify-content-end">
        <div class="d-flex flex-wrap justify-content-end">
         <div class="d-flex justify-content-end align-items-end">
            <a href="{{ route('patients.assistants-appointment.calendar') }}" class="btn btn-icon btn-primary me-2 ms-xl-3">
                ...
                <div class="dropdown-menu py-0" aria-labelledby="patientPanelApptFilterBtn">
                    ...
                    <div class="p-5">
                        <div class="mb-5">
                            ...
                            {{ Form::select('payment_type', collect($filterHeads[0])->toArray(), \App\Models\AppointmentAssistant::ALL_PAYMENT, ['class' => 'form-control form-control-solid form-select', 'data-control' => 'select2', 'id' => 'patientPaymentStatus']) }}
                        </div>
                        <div class="mb-5">
                            <label for="filterBtn" class="form-label">{{ __('messages.assistant.status') }}:</label>
                            {{ Form::select('status', collect($filterHeads[1])->toArray(), \App\Models\AppointmentAssistant::BOOKED, ['class' => 'form-control form-control-solid form-select', 'data-control' => 'select2', 'id' => 'patientAppointmentStatus']) }}
                        </div>
                        <div class="d-flex justify-content-end">
            ...
            <div class="d-flex justify-content-end flex-wrap">
                ...
                <a type="button" class="ms-3 mt-3 btn btn-primary" href="{{ route('patients.assistants-appointment.create') }}"
                    data-turbo="false">
