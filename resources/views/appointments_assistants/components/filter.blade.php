...
<div class="d-flex flex-xxl-row flex-column  mt-md-0 mt-sm-3">
    ...
    <div class="d-flex justify-content-end flex-wrap">
        <div class="d-flex mt-3 align-items-center">
            <a href="{{ route('asstts-apptmt.calendar') }}" class="btn btn-icon btn-primary me-2 ms-xl-3">
       ...
       <div class="d-flex align-items-center flex-wrap justify-content-end">
        ...
        <div class="ms-3 mt-3">
            <a type="button" class="btn btn-primary" href="{{ route('asstts-apptmt.create') }}" data-turbo="false">
