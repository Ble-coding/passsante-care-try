<div class="row">
    ...
    <div class="col-12 mb-5 mt-5">
        {{ Form::label('date', __('messages.appointment.date') . ':', ['class' => 'form-label']) }}
        {{ Form::date('date', null, ['class' => 'form-control', 'id' => 'appointmentDate', 'placeholder' => __('messages.appointment.date'), 'required']) }}
    </div>
    
    <div class="col-12 mb-5">
        {{ Form::label('heure', __('messages.appointment.time') . ':', ['class' => 'form-label']) }}
        {{ Form::time('time', null, ['class' => 'form-control', 'id' => 'appointmentTime', 'placeholder' => __('messages.appointment.time'), 'required']) }}
    </div>
    <div class="col-12 mb-5 mt-5">
        {{ Form::label('datetime', __('messages.appointment.datetime') . ':', ['class' => 'form-label']) }}
        {{ Form::datetimeLocal('datetime', null, ['class' => 'form-control', 'id' => 'appointmentDatetime', 'placeholder' => __('messages.appointment.datetime'), 'required']) }}
    </div>
    <div class="col-12 mb-5 mt-5">
        {{ Form::label('datetime', __('messages.appointment.datetime') . ':', ['class' => 'form-label']) }}
        <input type="text" id="appointmentDatetime" class="form-control" placeholder="{{ __('messages.appointment.datetime') }}" required>
    </div>
