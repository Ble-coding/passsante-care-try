{{-- <div class="d-flex justify-content-center">
    <a
    href="
    {{ route('admin.admin.appointmentPdf', $row->id) }}
    "
        target="_blank"
...
<div class="d-flex justify-content-center">
    {{-- <a href="{{ route('admin.appointments.appointmentPdf', $row->id) }}" target="_blank"
       class="btn px-1 text-primary fs-3" data-bs-toggle="tooltip"
       data-bs-original-title="{{ __('messages.common.download') }}">
       <i class="fa fa-download" aria-hidden="true"></i>
    </a> --}}
    <a href="{{ route('appointmentPdf', $row->id) }}" target="_blank"
        class="btn px-1 text-primary fs-3" data-bs-toggle="tooltip"
        data-bs-original-title="{{ __('messages.common.download') }}">
        <i class="fa fa-download" aria-hidden="true"></i>
     </a>
