...
@section('content')
                            ...
                            <div class="dashbord-doctor-card-body d-flex align-items-center justify-content-between">
                                <div class="align-items-center py-3 py-sm-1">
                                    <div class="image image-circle image-mini">
                                        ...
                                        @elseif(getLogInUser()->hasRole('assistant'))
                                            <img class="img-fluid doctor-card-img" alt="img-fluid"
                                ...
                                <div class="col-5 ">
                                    <div class="">
                                        <div class="float-end">
                                            ...
                                            <a href="{{route('profile.setting')}}" class="btn btn-primary px-2 py-1">{{__('messages.assistant.profile')}} →</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-8">
                        <div class="row">
                            <div class="col-xxl-4 col-xl-4 col-md-6 widget">
                                <a href="{{ url('assistants/appointments') }}"
                                   class="text-decoration-none">
                                    <div class="doctor-wiget-appointment-card1 rounded-10 p-xxl-8 px-7 py-10 d-flex align-items-center justify-content-between mb-5">
                                        <div class="text-start text-dark">
                                            <h3 class="mb-0 fs-6 mb-3 fw-light">{{__('messages.assistant_dashboard.total_appointments')}}</h3>
                ...
                <div class="col-xxl-12">
                    <div class="d-flex border-0 pt-5">
                        <h3 class="align-items-start flex-column">
                            <span class="fw-bolder fs-3 mb-1">{{__('messages.assistant_dashboard.recent_appointments')}}</span>
                        </h3>
                        ...
                        <div class="table-responsive livewire-table">
                            <table class="table table-striped">
                                ...
                                <tr class="text-uppercase">
                                    <th class="w-25px text-muted mt-1 fw-bold fs-7">{{__('messages.assistant_appointment.patient')}}</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="{{route('assistants.patient.detail',$appointment->patient_id)}}"
    ...
    @include('assistant_dashboard.templates.templates')
@endsection
