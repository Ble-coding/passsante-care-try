...
mix.js([
    ...
    'resources/assets/js/assistants/assistants.js',
    'resources/assets/js/assistants/create-edit.js',
    'resources/assets/js/assistants/detail.js',
    ...
    'resources/assets/js/patients/assistant-patient-appointment.js',
    ...
    'resources/assets/js/assistant_sessions/assistant_sessions.js',
    'resources/assets/js/assistant_sessions/create-edit.js',

    'resources/assets/js/service_categories/service_categories.js',
    'resources/assets/js/service_categories_assistants/service_categories.js',
    ...
    'resources/assets/js/services_assistants/services.js',
    'resources/assets/js/services/create-edit.js',
    'resources/assets/js/services_assistants/create-edit.js',
    ...
    'resources/assets/js/appointments_assistant/appointments.js',
    'resources/assets/js/appointments_assistant/patient-appointments-assistant.js',
    'resources/assets/js/appointments_assistant/create-edit.js',
    ...
    'resources/assets/js/dashboard/assistant-dashboard.js',

    'resources/assets/js/assistant_appointments/assistant_appointments.js',
    'resources/assets/js/assistant_appointments/calendar.js',

    'resources/assets/js/appointments/patient-calendar.js',
    'resources/assets/js/appointments/calendar.js',

    'resources/assets/js/appointments_assistant/patient-calendar.js',
    'resources/assets/js/appointments_assistant/calendar.js',
    ...
    'resources/assets/js/clinic_schedule_assistant/create-edit.js',
    ...
    'resources/assets/js/reviews_assistant/review.js',
    ...
    'resources/assets/js/assistant_holiday/assistant_holiday.js',
...
mix.js('resources/assets/js/custom/helper.js', 'public/assets/js/custom');
...
mix.js([
    ...
    'resources/assets/js/fronts/appointments/book_appointment.js',
    'resources/assets/js/fronts/appointments_assistant/book_appointment.js',
